...
static const MoType REST_MODEL[_REST_SIZE]=                 {REST, NONE};
static const MoType FIRST_LV_ALL_MODEL[_1ST_LV_ALL_SIZE] =  {REST, ASC, DSC, WALK, RUN, TL};
...
static const char* REST_FN     =        "REST";
