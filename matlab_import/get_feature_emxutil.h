/*
 * get_feature_emxutil.h
 *
 * Code generation for function 'get_feature_emxutil'
 *
 */

#ifndef GET_FEATURE_EMXUTIL_H
#define GET_FEATURE_EMXUTIL_H
...
/* End of code generation (get_feature_emxutil.h) */
