...
emlrtContext emlrtContextGlobal = { true, false, 131434U, NULL, "get_feature",
...
void get_feature_api(const mxArray *prhs[1], const mxArray *plhs[2])
{
  emxArray_real_T *m;
  emxArray_real_T *r;
  ...
  emxInit_real_T(&st, &features, 2, true);
...
/* End of code generation (_coder_get_feature_api.c) */
